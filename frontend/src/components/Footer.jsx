      ...
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
            ...
            <ul className='flex flex-col gap-1 text-gray-600 text-[12px]'>
                ...
                <li>
                    <Link to="/about" className="hover:text-black hover:underline">About us</Link>
                </li>
                <li>
                    <Link to="/delivery" className="hover:text-black hover:underline">Delivery</Link>
                </li>
                <li>
                    <Link to="/privacy" className="hover:text-black hover:underline">Privacy Policy</Link>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className='flex flex-col gap-1 text-gray-600 text-[12px]'>
                ...
                <li>
                    <a
                        ...
                        className="inline-flex items-center gap-2 border border-black px-3 py-1 hover:bg-black hover:text-white transition-all"
                    >
                ...
                <li>
                    <span className="inline-flex items-center gap-2 border border-black px-3 py-1">
                ...
                <li>
                    <a
                        ...
                        className="inline-flex items-center gap-2 border border-black px-3 py-1 hover:bg-black hover:text-white transition-all"
                    >
                        <img src={assets.tiktok} alt="TikTok" className="w-4 h-4" />
                        TikTok
                    </a>
                </li>
            </ul>
