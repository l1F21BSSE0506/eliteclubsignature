      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex gap-4 flex-wrap'>
          <a
            ...
            className='border border-black px-6 py-4 text-sm hover:bg-black hover:text-white transition-all duration-500 inline-flex items-center gap-2'
          >
            <img src={assets.instagram} alt='Instagram' className='w-5 h-5' />
            Instagram
          </a>
          <span className='border border-black px-6 py-4 text-sm inline-flex items-center gap-2'>
