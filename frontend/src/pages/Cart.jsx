                  ...
                  <div className='flex items-center gap-5 mt-2'>
                    {productData.discount > 0 ? (
                      <div className="flex items-center gap-2">
                         <p>{currency}{(productData.price - (productData.price * productData.discount / 100)).toFixed(0)}</p>
                         <p className="text-gray-500 line-through text-xs">{currency}{productData.price}</p>
                      </div>
                    ) : (
